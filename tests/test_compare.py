...
try:
    ...
    v_database.Execute('create table depts1 as select t.*, random() as val from departments t')
    ...
    v_database.Execute("update depts2 set val = 20020, dept_name = 'Marketing and Promotion' where dept_no = 'd001'")
